        ...
        if (wingscode == 1):
            ...
            while (2):
                ...
                if receive < total:
                    ...
                    if wings_1 > 0:
                        print(f"Buffalo Wings           $10       {a}       ${wings_0}  ")
                    if wings_2 > 0:
                        print(f"Garlic Parmesan Wings   $12       {b}       ${wings_0} ")
                    if wings_3 > 0:
                        print(f"Spicy Wings             $15       {c}       ${wings_0}")
                        print(f"                                    Total:${total} \n                                     Cash:${receive}")            
